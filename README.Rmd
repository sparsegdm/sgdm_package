...
Leitão, J. P., Schwieder, M., and Senf, C. (*in press*) sgdm: an R package for performing sparse generalized dissimilarity modelling, including tools for gdm. *ISPRS International Journal of Geo-Information*.
